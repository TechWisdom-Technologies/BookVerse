          ...
          {loading ? (
            ...
            <div className="hidden items-center gap-2 md:flex">
              <Link
                ...
                className="inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm text-zinc-600 hover:bg-zinc-50 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-900 dark:hover:text-zinc-50 transition-colors"
              >
                {dbUser?.avatarUrl ? (
                  <img
                ...
                <span className="max-w-[100px] truncate">
                  {dbUser?.displayName || dbUser?.username || "Profile"}
                </span>
              </Link>
              <button
                onClick={() => signOut()}
