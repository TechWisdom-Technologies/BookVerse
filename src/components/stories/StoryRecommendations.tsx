...
export function StoryRecommendations() {
  ...
  if (loading) {
    return (
      <div className="space-y-6 animate-pulse p-4 sm:p-0">
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-0 border-b border-zinc-200 dark:border-zinc-900 pb-4">
  ...
  return (
    <section className="relative overflow-hidden rounded-2xl border border-zinc-100 dark:border-zinc-900 bg-gradient-to-br from-white/50 to-zinc-50/30 dark:from-zinc-950/20 dark:to-zinc-900/10 p-4 sm:p-8 backdrop-blur-xl transition hover:shadow-lg">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-0 mb-6 sm:mb-8 pb-4 border-b border-zinc-100 dark:border-zinc-900">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-6">
        {recommendations.map((story) => (
          <div key={story.id} className="transition transform duration-300 hover:-translate-y-1 max-w-sm mx-auto w-full">
