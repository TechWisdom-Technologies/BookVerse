        ...
        <main className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 pb-12 md:pb-16">
            <div className="max-w-[95rem] mx-auto px-4 sm:px-6 md:px-12 lg:px-16 py-8 md:py-16">
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            <h1 className="text-2xl md:text-3xl font-bold tracking-tight mb-2 md:mb-3 flex items-center gap-2 md:gap-3">
                                Performance Registry <Sparkles className="w-5 h-5 md:w-6 md:h-6 text-indigo-500 animate-pulse" />
                            </h1>
                            <p className="text-xs md:text-sm text-zinc-500 font-bold max-w-2xl leading-relaxed">Advanced manuscript metrics, computed engagement indexes, and yield data. Explore how your stories are performing across the Bookverse universe.</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-2 text-xs md:text-sm font-bold text-zinc-500 bg-zinc-50 dark:bg-zinc-900 px-4 md:px-5 py-2.5 md:py-3 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm w-fit">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8 mb-8 md:mb-12">
                    {[
                        { icon: BookOpen, label: "Manuscripts established", value: stats.totalStories, desc: "Total published and draft stories" },
                        { icon: Eye, label: "Total views logged", value: stats.totalViews, desc: "Cumulative reader pageviews" },
                        { icon: Heart, label: "Reader reactions", value: stats.totalReactions, desc: "All sentiments combined" },
                        { icon: MessageSquare, label: "Comments index", value: stats.totalComments, desc: "Total community discussions" },
                    ].map((s, i) => (
                        <div key={i} className="p-6 md:p-8 bg-white dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800/60 shadow-sm rounded-2xl flex flex-col justify-between min-h-[140px] md:min-h-[160px] hover:shadow-md transition-shadow">
                            ...
                            <div>
                                <div className="text-2xl md:text-3xl font-bold tracking-tight mb-1">{s.value.toLocaleString()}</div>
                                <div className="text-[11px] md:text-xs text-zinc-400 font-medium">{s.desc}</div>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <section className="mb-10 md:mb-12 animate-fade-in">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-2 border-b border-zinc-100 dark:border-zinc-900">
                        <div className="flex items-center gap-2">
                            <Layers className="w-4 h-4 text-zinc-400" />
                            <h2 className="text-xl md:text-2xl text-zinc-900 dark:text-white font-bold">Collections Intelligence</h2>
                        </div>
                    </div>

                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                        {/* Universes */}
                        <div className="p-6 md:p-8 border border-zinc-100 dark:border-zinc-900 bg-white dark:bg-zinc-950 rounded-xl shadow">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 mb-10 md:mb-12">

                    {/* Sentiment distribution bar chart card */}
                    <div className="lg:col-span-2 p-6 md:p-8 border border-zinc-100 dark:border-zinc-900 bg-white dark:bg-zinc-950 rounded-xl shadow flex flex-col justify-between space-y-6">
                        <div>
                            <div className="flex items-center gap-2 mb-6 pb-2 border-b border-zinc-100 dark:border-zinc-900">
                                <Smile className="w-4 h-4 text-zinc-400" />
                                <h3 className="text-lg md:text-xl font-semibold text-zinc-800 dark:text-zinc-100 mb-2">Audience Sentiment Distribution</h3>
                            </div>
                            {totalSentimentVotes === 0 ? (
                                ...
                                <div className="space-y-4">
                                    {[
                                        { type: 'LOVE', label: 'Loves', val: sentimentStats.LOVE, pct: ((sentimentStats.LOVE / totalSentimentVotes) * 100).toFixed(0), color: 'bg-zinc-900 dark:bg-white' },
                                        { type: 'FIRE', label: 'Fires', val: sentimentStats.FIRE, pct: ((sentimentStats.FIRE / totalSentimentVotes) * 100).toFixed(0), color: 'bg-zinc-900 dark:bg-white' },
                                        { type: 'LIKE', label: 'Likes', val: sentimentStats.LIKE, pct: ((sentimentStats.LIKE / totalSentimentVotes) * 100).toFixed(0), color: 'bg-zinc-900 dark:bg-white' },
                                        { type: 'WOW', label: 'Wows', val: sentimentStats.WOW, pct: ((sentimentStats.WOW / totalSentimentVotes) * 100).toFixed(0), color: 'bg-zinc-900 dark:bg-white' },
                                        { type: 'CRY', label: 'Sad/Crys', val: sentimentStats.CRY, pct: ((sentimentStats.CRY / totalSentimentVotes) * 100).toFixed(0), color: 'bg-zinc-900 dark:bg-white' },
                                    ].map((s, idx) => (
                    ...
                    <div className="p-6 md:p-8 border border-zinc-100 dark:border-zinc-900 bg-white dark:bg-zinc-950 rounded-xl shadow flex flex-col justify-between space-y-6">
                        <div>
                            <div className="flex items-center gap-2 mb-6 pb-2 border-b border-zinc-100 dark:border-zinc-900">
                                ...
                                <h3 className="text-lg md:text-xl font-semibold text-zinc-800 dark:text-zinc-100 mb-2">Reader Completion Telemetry</h3>
                            </div>
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <div className="w-full h-4 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-full overflow-hidden mt-3 shadow-inner">
                                        <div className="h-full bg-zinc-900 dark:bg-white rounded-full transition-all duration-1000 ease-out relative overflow-hidden" style={{ width: `${readingCompletion.averageProgress}%` }}><div className="absolute inset-0 bg-white/20 w-full animate-pulse" /></div>
                                    </div>
                                </div>
                ...
                {analytics.creatorInsights && (
                    <section className="mb-10 md:mb-16 space-y-6 md:space-y-8 animate-fade-in">
                        <div className="flex items-start md:items-center gap-3">
                            <Sparkles className="w-5 h-5 text-indigo-500 animate-pulse shrink-0 mt-1 md:mt-0" />
                            <div>
                                <h2 className="text-xl md:text-2xl font-bold text-zinc-900 dark:text-white">Creator Demographics (Identities)</h2>
                                <p className="text-xs md:text-sm text-zinc-500 font-bold mt-0.5">Exclusive itemized identity lists of your audience base.</p>
                            </div>
                        </div>
                ...
                {/* ========================================== */}
                <section className="mb-10 md:mb-16 space-y-8 md:space-y-12 animate-fade-in">

                    <div className="flex items-start md:items-center gap-3">
                        <Sparkles className="w-5 h-5 text-indigo-500 animate-pulse shrink-0 mt-1 md:mt-0" />
                        <div>
                            <h2 className="text-xl md:text-2xl font-bold text-zinc-900 dark:text-white">Creator Intelligence Telemetry</h2>
                            <p className="text-xs md:text-sm text-zinc-500 font-bold mt-0.5">Advanced platform amplification, engagement focal indexing, and tipping projection simulation tools.</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                        ...
                        <div className="p-6 md:p-8 border border-zinc-100 dark:border-zinc-900 bg-white dark:bg-zinc-950 rounded-xl shadow flex flex-col justify-between min-h-[300px]">
                            <div>
                                <div className="flex items-center justify-between pb-3 border-b border-zinc-100 dark:border-zinc-800/40">
                                    <div className="flex items-center gap-2">
                                        <Share2 className="w-4 h-4 text-zinc-400" />
                                        <h3 className="text-base md:text-lg font-semibold text-zinc-800 dark:text-zinc-100">Viral Platform Amplification</h3>
                                    </div>
                            ...
                            <div>
                                <div className="flex items-center justify-between pb-3 border-b border-zinc-100 dark:border-zinc-800/40">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h3 className="text-base md:text-lg font-semibold text-zinc-800 dark:text-zinc-100">Reading Focus Index</h3>
                                    </div>
                            ...
                            <div>
                                <div className="flex items-center justify-between pb-3 border-b border-zinc-100 dark:border-zinc-800/40">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h3 className="text-base md:text-lg font-semibold text-zinc-800 dark:text-zinc-100">Reader Annotations Heatmap</h3>
                                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-8">
                        ...
                        <div className="p-6 md:p-8 border border-zinc-100 dark:border-zinc-900 bg-white dark:bg-zinc-950 rounded-xl shadow space-y-6">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-3 border-b border-zinc-100 dark:border-zinc-800/40">
                                <div className="flex items-center gap-2">
                                    <Layers className="w-4 h-4 text-zinc-400" />
                                    <h3 className="text-base md:text-lg font-semibold text-zinc-800 dark:text-zinc-100">Chapter Retention Cohort Drop-Off</h3>
                                </div>
                                <div className="flex items-center gap-3">
                                    <select
                                        value={selectedRetentionStory}
                                        onChange={(e) => setSelectedRetentionStory(e.target.value)}
                                        className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg text-xs md:text-sm font-bold px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-indigo-500 max-w-[150px] md:max-w-[200px]"
                                    >
                                    ...
                                    {(selectedRetentionStory === 'all' ? cohortRetention : analytics.retentionByStory[selectedRetentionStory] || []).map((ch, idx) => (
                                        <div key={idx} className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1 h-4 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-full overflow-hidden relative shadow-inner">
                                                <div className="h-full bg-zinc-900 dark:bg-white rounded-full transition-all duration-1000 ease-out relative overflow-hidden" style={{ width: `${ch.rate}%` }}><div className="absolute inset-0 bg-white/10 w-full" /></div>
                                            </div>
                ...
                {promotionAnalytics && promotionAnalytics.length > 0 && (
                    <section className="mb-10 md:mb-16 animate-fade-in">
                        <div className="flex items-center gap-2 mb-6 md:mb-8 pb-2 border-b border-zinc-100 dark:border-zinc-900">
                            <TrendingUp className="w-4 h-4 text-zinc-400" />
                            <h2 className="text-xl md:text-2xl font-bold text-zinc-900 dark:text-white">Promotion Campaign Analytics</h2>
                        </div>
                        ...
                        <div className="p-6 md:p-8 border border-zinc-100 dark:border-zinc-900 bg-white dark:bg-zinc-950 rounded-xl shadow space-y-6">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-3 border-b border-zinc-100 dark:border-zinc-800/40">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-base md:text-lg font-semibold text-zinc-800 dark:text-zinc-100">Campaign Deep-Dive</h3>
                                </div>
                                <div className="flex items-center gap-3">
                                    <select
                                        value={selectedPromotion}
                                        onChange={(e) => setSelectedPromotion(e.target.value)}
                                        className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg text-xs md:text-sm font-bold px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-indigo-500 max-w-[200px] md:max-w-[250px]"
                                    >
                                ...
                                return (
                                    <div key={promo.id} className="space-y-6">
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                            <div className="flex items-center gap-3">
                                                <span className={`text-xs font-bold px-2.5 py-1 rounded-md ${promo.tier === 'FEATURED' ? 'bg-amber-50 dark:bg-amber-900/20 text-amber-500' :
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className={`text-xs font-bold px-2.5 py-1 rounded-md ${isActive ? 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-500' :
                                                        isPending ? 'bg-amber-50 dark:bg-amber-900/20 text-amber-500' :
                                                            isEnded ? 'bg-rose-50 dark:bg-rose-900/20 text-rose-500' :
                                                                'bg-zinc-100 dark:bg-zinc-800 text-zinc-500'
                                                    }`}>{displayStatus}</span>
                                                <span className={`text-xs font-bold ${promo.roiRating === 'Excellent' ? 'text-emerald-500' :
                                            ...
                                            {totalReactionCount > 0 && (
                                                <>
                                                    <div className="w-full h-4 bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 rounded-full overflow-hidden flex shadow-inner">
                                                        <div className="h-full bg-zinc-900 dark:bg-white rounded-l-full transition-all duration-1000 ease-out" style={{ width: `${promo.sentimentScore}%` }} />
                                                        <div className="h-full bg-zinc-400 dark:bg-zinc-500 rounded-r-full transition-all duration-1000 ease-out" style={{ width: `${negativePercent}%` }} />
                                                    </div>
                ...
                <div className="my-24 border-b border-zinc-200 dark:border-zinc-800/60" />
                ...
                {topStories.length > 0 && (
                    <section className="mb-10 md:mb-16">
                        <div className="flex items-center gap-2 mb-6 md:mb-8 pb-2 border-b border-zinc-100 dark:border-zinc-900">
                            ...
                            <h2 className="text-xl md:text-2xl font-bold text-zinc-900 dark:text-white">High-Velocity Manuscripts</h2>
                        </div>
                ...
                <section className="bg-white dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-900 rounded-xl p-4 sm:p-6 md:p-8 shadow">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-6 md:mb-8 pb-4 md:pb-6 border-b border-zinc-100 dark:border-zinc-900">
                        <div className="flex items-center gap-2">
                            <BookOpen className="w-4 h-4 text-zinc-400" />
                            <h2 className="text-xl md:text-2xl font-bold text-zinc-900 dark:text-white">Manuscripts Registry logs</h2>
                        </div>
                            ...
                            <div className="flex bg-zinc-50 dark:bg-zinc-900 p-1 border border-zinc-100 dark:border-zinc-800 rounded-xl">
                                {(['all', 'published', 'draft'] as const).map(option => (
                                    <button
                                        ...
                                        className={`px-3 py-1 text-xs font-bold rounded-lg transition-all ${statusFilter === option
                                        ...
                                        return (
                                            <tr key={story.id} className="group hover:bg-zinc-50/40 dark:hover:bg-zinc-900/20 transition-all">
                                                ...
                                                <td className="py-4 px-3 text-center">
                                                    <span className={`text-xs font-bold px-2.5 py-1 rounded-lg flex items-center justify-center gap-1.5 mx-auto w-fit ${story.published ? "text-emerald-500 bg-emerald-500/5 border border-emerald-500/10" : "text-zinc-400 bg-zinc-50 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800"
                                                        }`}>
                ...
                {/* Analytics Legend & Guide */}
                <section className="bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 sm:p-8 md:p-12 mb-8">
                    <div className="max-w-4xl">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-6 sm:mb-8 pb-6 border-b border-zinc-200 dark:border-zinc-800/60">
                            <div className="p-3 bg-white dark:bg-zinc-800 rounded-xl shadow-sm w-fit">
                                <BookOpen className="w-5 h-5 text-indigo-500" />
                            </div>
                            <div>
                                <h2 className="text-xl md:text-2xl font-bold text-zinc-900 dark:text-white">Analytics Guide & Legend</h2>
                                <p className="text-xs md:text-sm text-zinc-500 font-medium mt-1">Understanding your creator performance metrics</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mb-1">Global Stats Registry</h3>
                                        <p className="text-sm text-zinc-500 leading-relaxed">
                                            The top summary cards show the total combined metrics for all your published and drafted manuscripts. It represents the absolute lifetime performance of your author account.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mb-1">Collections Intelligence</h3>
                                        <p className="text-sm text-zinc-500 leading-relaxed">
                                            Breaks down performance by grouped content. <strong>Universes</strong> show metrics for broad fictional worlds you've built, while <strong>Series</strong> track sequential stories connected together.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mb-1">Audience Sentiment & Completion</h3>
                                        <p className="text-sm text-zinc-500 leading-relaxed">
                                            <strong>Sentiment</strong> analyzes the emotional response to your stories (Likes vs Loves vs Sad). <strong>Completion Telemetry</strong> tracks the average percentage of your book a reader finishes before leaving.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mb-1">Creator Demographics</h3>
                                        <p className="text-sm text-zinc-500 leading-relaxed">
                                            See exactly <em>who</em> is engaging with your profile. This itemizes your recent followers, newsletter subscribers, and the readers who have tipped/sponsored your work.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mb-1">Viral Platform Amplification</h3>
                                        <p className="text-sm text-zinc-500 leading-relaxed">
                                            Monitors external reach. If readers share your book on social media (Twitter, Facebook, WhatsApp), this section logs how often and on which platforms your link is amplified.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mb-1">Reading Focus Index & Drop-Off</h3>
                                        <p className="text-sm text-zinc-500 leading-relaxed">
                                            <strong>Focus Index</strong> measures average session intensity (chapters per sitting). The <strong>Drop-Off Matrix</strong> highlights exactly at which chapter readers tend to stop reading, helping you identify pacing issues.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mb-1">Promotion Analytics</h3>
                                        <p className="text-sm text-zinc-500 leading-relaxed">
                                            If you run paid campaigns, this tracks your Return on Investment (ROI). It measures the cost-per-view and how many tips/followers were directly attributed to a specific ad campaign.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <BookOpenCheck className="w-5 h-5 text-indigo-500 shrink-0 mt-0.5" />
                                    <div>
                                        <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mb-1">Manuscripts Registry</h3>
                                        <p className="text-sm text-zinc-500 leading-relaxed">
                                            A detailed, sortable table of every story you've created. Click on table headers to sort by Engagement Rate, Tips, or Views. Use the filters to narrow down to just Live or Draft stories.
                                        </p>
                                    </div>
                                </div>
                            </div>
